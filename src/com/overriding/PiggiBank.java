 ...
 * Create a class 'AddAmount' with a data member named 'amount' with an initial value of $50. Now make two
...
System.out.println("final amount is "+obj1.amount);
	}

}
class AddAmount extends PiggiBank {
